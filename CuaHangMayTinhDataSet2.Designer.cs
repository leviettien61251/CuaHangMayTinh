...
namespace CuaHangMayTinh {
    ...
    public partial class CuaHangMayTinhDataSet2 : global::System.Data.DataSet {
        ...
        public partial class NhaCungCapDataTable : global::System.Data.TypedTableBase<NhaCungCapRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhaCungCapRow AddNhaCungCapRow(string TenNCC, string DiaChi, string SoDienThoai, string Email, int MaTK) {
        ...
        public partial class NhaCungCapRow : global::System.Data.DataRow {
            ...
            public int MaTK {
                get {
                    try {
                        return ((int)(this[this.tableNhaCungCap.MaTKColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'MaTK\' in table \'NhaCungCap\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableNhaCungCap.MaTKColumn] = value;
                }
            }
            ...
            public bool IsMaTKNull() {
                return this.IsNull(this.tableNhaCungCap.MaTKColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetMaTKNull() {
                this[this.tableNhaCungCap.MaTKColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace CuaHangMayTinh.CuaHangMayTinhDataSet2TableAdapters {
    ...
    public partial class NhaCungCapTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@IsNull_MaTK";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
            param.SourceColumn = "MaTK";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            param.SourceColumnNullMapping = true;
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Original_MaTK";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
            param.SourceColumn = "MaTK";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NhaCungCap] ([TenNCC], [DiaChi], [SoDienThoai], [Email], [MaTK" +
                "]) VALUES (@TenNCC, @DiaChi, @SoDienThoai, @Email, @MaTK);\r\nSELECT MaNCC, TenNCC" +
                ", DiaChi, SoDienThoai, Email, MaTK FROM NhaCungCap WHERE (MaNCC = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhaCungCap] SET [TenNCC] = @TenNCC, [DiaChi] = @DiaChi, [SoDienThoai] = @SoDienThoai, [Email] = @Email, [MaTK] = @MaTK WHERE (([MaNCC] = @Original_MaNCC) AND ([TenNCC] = @Original_TenNCC) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_SoDienThoai = 1 AND [SoDienThoai] IS NULL) OR ([SoDienThoai] = @Original_SoDienThoai)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_MaTK = 1 AND [MaTK] IS NULL) OR ([MaTK] = @Original_MaTK)));
SELECT MaNCC, TenNCC, DiaChi, SoDienThoai, Email, MaTK FROM NhaCungCap WHERE (MaNCC = @MaNCC)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNCC, TenNCC, DiaChi, SoDienThoai, Email, MaTK FROM dbo.NhaCungCap";
        ...
        public virtual int Fill(CuaHangMayTinhDataSet2.NhaCungCapDataTable dataTable) {
        ...
        public virtual CuaHangMayTinhDataSet2.NhaCungCapDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CuaHangMayTinhDataSet2.NhaCungCapDataTable dataTable = new CuaHangMayTinhDataSet2.NhaCungCapDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CuaHangMayTinhDataSet2.NhaCungCapDataTable dataTable) {
        ...
        public virtual int Delete(int Original_MaNCC, string Original_TenNCC, string Original_DiaChi, string Original_SoDienThoai, string Original_Email, global::System.Nullable<int> Original_MaTK) {
            ...
            if ((Original_MaTK.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((int)(Original_MaTK.Value));
            }
            else {
        ...
        public virtual int Insert(string TenNCC, string DiaChi, string SoDienThoai, string Email, global::System.Nullable<int> MaTK) {
            if ((TenNCC == null)) {
            ...
            if ((MaTK.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((int)(MaTK.Value));
            }
            else {
        ...
        public virtual int Update(string TenNCC, string DiaChi, string SoDienThoai, string Email, global::System.Nullable<int> MaTK, int Original_MaNCC, string Original_TenNCC, string Original_DiaChi, string Original_SoDienThoai, string Original_Email, global::System.Nullable<int> Original_MaTK, int MaNCC) {
            if ((TenNCC == null)) {
                throw new global::System.ArgumentNullException("TenNCC");
            }
            else {
            ...
            if ((MaTK.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(MaTK.Value));
            }
            else {
            ...
            if ((Original_MaTK.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_MaTK.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenNCC, string DiaChi, string SoDienThoai, string Email, global::System.Nullable<int> MaTK, int Original_MaNCC, string Original_TenNCC, string Original_DiaChi, string Original_SoDienThoai, string Original_Email, global::System.Nullable<int> Original_MaTK) {
            return this.Update(TenNCC, DiaChi, SoDienThoai, Email, MaTK, Original_MaNCC, Original_TenNCC, Original_DiaChi, Original_SoDienThoai, Original_Email, Original_MaTK, Original_MaNCC);
        }
    }
